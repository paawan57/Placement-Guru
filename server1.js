...
app.post('/pdfviewer1', function(req, res, next) {
  var stream = fs.createReadStream('D:/Project_to_show/Functions.pdf');
...
app.post('/pdfviewer2', function(req, res, next) {
  var stream = fs.createReadStream('D:/Project_to_show/structuresUnions.pdf');
...
app.post('/pdfviewer3', function(req, res, next) {
  var stream = fs.createReadStream('C:/Users/Dell/Desktop/compilex/PointersArrays.pdf');
...
app.post('/pdfviewer4', function(req, res, next) {
  var stream = fs.createReadStream('D:/Project_to_show/Inheritance.pdf');
...
app.post('/pdfviewer5', function(req, res, next) {
  var stream = fs.createReadStream('C:/Users/Dell/Desktop/compilex/templates.pdf');
...
app.post('/pdfviewer6', function(req, res, next) {
  var stream = fs.createReadStream('D:/Project_to_show/friendfunction.pdf');
...
app.post('/pdfviewer7', function(req, res, next) {
  var stream = fs.createReadStream('D:/Project_to_show/LinkedLists.pdf');
...
app.post('/pdfviewer8', function(req, res, next) {
  var stream = fs.createReadStream('D:/Project_to_show/BinaryTrees.pdf');
...
app.post('/pdfviewer9', function(req, res, next) {
  var stream = fs.createReadStream('./Graphs.pdf');
...
app.post('/pdfviewer10', function(req, res, next) {
  var stream = fs.createReadStream('D:/Project_to_show/fileHandling.pdf');
...
app.post('/pdfviewer11', function(req, res, next) {
  var stream = fs.createReadStream('D:/Project_to_show/Dp.pdf');
  var filename = "Dp.pdf"; 
  // Be careful of special characters
...
//res.end('<a href="/logout">Logout</a>');
        ...
        con.query('select apt_marks,tech_marks,eng_marks from result where roll_no=\''+sess.roll_no+'\'',function(err,rest)
    {
      ...
      console.log(rest);
     if(err)throw err;
     res.render('admin.html',{name:name,branch:branch,year:year,apt:rest[0].apt_marks,tech:rest[0].tech_marks,eng:rest[0].eng_marks,roll_no:sess.roll_no});
    });
   ...
   // document.getElementById(label).value="<h1>Hello '+sess.roll_no+'</h1>";
} else {
...
app.post("/upload_pdf", urlencodedParser,function(req, res) {
 ...
 app.post('/test_compiler',urlencodedParser,function(req,res){
          ...
          if(req.query.lang=='C'||req.query.lang=='CPP')
		  {
				...
				compiler.compileCPPWithInput(envData , req.query.code , req.query.input , function (data) {
		  ...
		  else if(req.query.lang=='Java')
		  {
				...
				compiler.compileJavaWithInput( envData , req.query.code , req.query.input ,  function(data){
				if(data.output+""=="undefined")
				res.end(data.error+"");
				else
				res.end(data.output+"");
		  ...
		  {
			    var envData = { OS : "windows"};
				 compiler.compilePythonWithInput( envData , req.query.code , req.query.input ,  function(data){
